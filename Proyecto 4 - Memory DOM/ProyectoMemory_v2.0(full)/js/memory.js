...
class Memory extends Tablero {
  ...
  */
  ...
  // Cambia el valor de la celda descubierta transcurridas ocho décimas de segundo para que no contenga ninguna imagen.
  ...
  partidaGanada() {
    setTimeout(() => {
      ...
      alert("¡HAS GANADO!");
      alert("Has parado el crono en " + tiempoTranscurrido + " segundos\n y has conseguido " + this.puntuacion +
