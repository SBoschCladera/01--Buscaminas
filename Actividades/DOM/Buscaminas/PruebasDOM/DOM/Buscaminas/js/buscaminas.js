    ...
    dibujarTablero() {
        ...
        for (let i = 0; i < this.filas; i++) {
            ...
            for (let j = 0; j < this.columnas; j++) {
               ...
               //  td.addEventListener('click', this.verContenido); // Añade un evento para un click
                  td.onclick = function() {document.body.innerHTML += "hola-" };
...
//window.addEventListener("load", buscaminas1.verContenido());
