    ...
    for (let columna = 0; columna < maxColumnas; columna++) {
        ...
        if (arrayTablero[fila][columna] != 'X') {
            for (let cFila = fila - 1; cFila < fila + 1; cFila++) {
                if (cFila >= 0 && cFila < (maxFilas - 1)) {                      // Condicional para no comprobar que cFila sea igual o mayor que la fila 0 y menor que la última fila.
                    for (let cColumna = columna - 1; cColumna < columna + 1; cColumna++) {
                        if (cColumna >= 0 && cColumna < (maxColumnas - 1)) {     // Condicional para no comprobar que cColumna sea igual o mayor que la columna 0 y menor que la última columna.
                            if ((cFila >= 0 && cFila < maxFilas) && (cColumna >= 0 && cColumna < maxColumnas)) {
                                if (arrayTablero[cFila][cColumna] == 'X') {
                                    numMinasAlrededor++;
                                }
                            }
                        }
